    ...
    if (check.status === "passed") {
      if (check.provenance === "operator-recorded") {
        ...
        const automated = { "live-sdk": ["AT02-prompt-tools", "AT03-thinking", "AUTO-SDK-thinking-single", "S02-live-results"],
          "live-commands": ["AUTO-CMD-prompt-idempotency", "AUTO-CMD-idle-config", "AUTO-CMD-stop-drafts", "CMD-steer-stop-drafts", "AUTO-CMD-compact-native-queue", "AUTO-CMD-compact-cancel-before-summary", "AUTO-CMD-compact-cancel-stream", "AUTO-CMD-active-config-recovery"],
